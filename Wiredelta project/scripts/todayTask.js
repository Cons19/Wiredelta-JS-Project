...
row = table.insertRow();
// insert a new cell on the new created <tr> element for the header of the table with both time and description
var headerTime = row.insertCell();
headerTime.innerHTML = "<b>Time</b>";
var headerDescription = row.insertCell();
headerDescription.innerHTML = "<b>Description</b>";
// create a new <tr> element
row = table.insertRow();  

for ( var i = 0; i < objlen; i++) {
	if(obj[i].day == days) { // looking in the json array for the today's day
		// insert a new cell on the new created <tr> element with the values from the json file for both time and description
		var timeCell = row.insertCell();
		timeCell.innerHTML = obj[i].time;
		var descriptionCell = row.insertCell();
		descriptionCell.innerHTML = obj[i].description;
	}
	// create a new <tr> element
	row = table.insertRow();
...
// append the table
document.getElementById("todayTask").appendChild(table);
